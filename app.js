...
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended/css/mdui_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended/css/mdui_v2.min.css">'
  );
}
if (UI.dark_mode) {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended/3456869088d565716450b227780432f4f717bb9e/css/nexmoe_v2_dark.min.css">'
  );
} else {
  document.write(
    '<link rel="stylesheet" href="//cdn.jsdelivr.net/gh/cheems/goindex-extended/3456869088d565716450b227780432f4f717bb9e/css/nexmoe_v2.min.css">'
  );
}
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended/js/mdui.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended/js/flv.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended/js/DPlayer.min.js"></script>'
);
document.write(
  '<script src="//cdn.jsdelivr.net/gh/cheems/goindex-extended/js/markdown-it.min.js"></script>'
);
document.write(
